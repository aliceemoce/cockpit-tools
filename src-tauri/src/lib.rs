...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::platform_installer::resolve_platform_installer,
            commands::platform_installer::download_platform_installer,
            commands::platform_installer::install_platform_installer,
            commands::platform_installer::install_missing_platform,
            commands::platform_installer::is_platform_install_supported,
