...
- **Fork sync**: merged upstream formal release **v1.3.17** into fork tip 1.3.18; kept Cursor local watch (sync_cursor_local_watch / ccounts:changed), rotation pick, email-dedup release boundary, and default-instance non-global kill.
...
- **Fork sync**: merged upstream formal release **v1.3.16** into fork tip 1.3.17; kept Cursor local watch (`sync_cursor_local_watch` / `accounts:changed`), rotation pick, email-dedup release boundary, and default-instance non-global kill.
...
- merge upstream **v1.3.14** into fork sync tip (**1.3.15** / upstream v1.3.13): keep Cursor watch, quota sort/refresh, rotation pick, and release boundaries.

### Upstream highlights (v1.3.14)

- Web Sessions can be registered automatically as Agent Identity accounts (API Service only).
- Fixed custom Responses API Key accounts with "Sync model catalog to Codex" being rejected by Codex API Service.

## [1.3.15] - 2026-07-22

### Changed

- merge upstream **v1.3.13** (includes upstream v1.3.11–v1.3.13) into fork sync tip **1.3.14** / upstream v1.3.10: keep Cursor watch, quota sort/refresh, rotation pick, and release boundaries.

### Upstream highlights (v1.3.11–v1.3.13)
