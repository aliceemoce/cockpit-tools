...
| 项 | 值 |
|----|-----|
| 上游 tag | `v1.3.10` @ `b331b093` |
| 集成分支 | `sync-upstream-v1.3.10-20260719` @ `57a1ae4a` |
| 交付版本 | ProductVersion **1.3.14**（fork tip 1.3.13 + upstream 1.3.10） |

## 主仓库 `jlcodes99/cockpit-tools` v1.3.8（历史同步，2026-07-18）

| 项 | 值 |
|----|-----|
| 上游 tag | `v1.3.8` @ `fb291416` |
| 集成分支 | `sync-upstream-v1.3.8-20260718` @ `b2d3d3aa` |
